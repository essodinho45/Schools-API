...
<head>
    ...
    <title>Abd Al-Qader Queider Web Application || مدرسة عبد القادر قويدر</title>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-green-500 sm:items-center py-4 sm:pt-0">
        ...
        <div class="grid grid-cols-1">
            ...
            <div class="grid grid-cols-1 justify-items-center">
                <iframe class="aspect-video md:w-7/12 w-11/12" src="https://www.youtube.com/embed/xISiu0r8Tq8?si=ba0cSsKxuIdFkrzr" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
