        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (auth()->user()->school_code != null)
                    <div
                        class="hidden space-x-8 sm:-my-px @if (App::isLocale('ar')) sm:mr-10 @else sm:ml-10 @endif sm:flex">
                        <x-jet-nav-link href="{{ route('remarkForStudents') }}" :active="request()->routeIs('remarkForStudents')">
                            {{ __('Send Remark') }}
                        </x-jet-nav-link>
                    </div>
                    <div
                        ...
                        <x-jet-nav-link href="{{ route('all-remarks') }}" :active="request()->routeIs('all-remarks')">
                            {{ __('Remarks') }}
                        </x-jet-nav-link>
                    </div>
                    <div
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
                ...
                <!-- Settings Dropdown -->
                <div class="ml-3 relative">
                    <x-jet-dropdown align="{{ \App::isLocale('ar') ? 'left' : 'right' }}" width="48">
                        <x-slot name="trigger">
